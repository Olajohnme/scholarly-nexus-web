        ...
        <div className="text-center text-white">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 mb-8">
              ...
              <span className="text-lg font-medium">A Publication of LAUTECH Teaching Hospital and Faculty of Clinical Sciences, LAUTECH, Ogbomoso, Oyo state</span>
            </div>
          </div>
          ...
          <div className="animate-fade-in-up stagger-2">
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <a href="https://ijmmslth.com/ojs/index.php/ijmms/issue/current" rel="noopener noreferrer" className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-primary transition-all duration-300 flex items-center space-x-2">
          ...
          <div className="animate-fade-in-up stagger-3 mt-16">
            <div className="bg-white/15 backdrop-blur-md rounded-2xl p-8 max-w-3xl mx-auto border border-white/30">
              ...
              <a href="https://ijmmslth.com/ojs/index.php/ijmms/issue/current" rel="noopener noreferrer" className="inline-flex items-center mt-6 text-blue-200 hover:text-white transition-colors font-medium">
